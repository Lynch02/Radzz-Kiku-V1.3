...
let handler = async (m, { conn, usedPrefix, command, text }) => {
  ...
  let hasil = await fetch(`https://xzn.wtf/api/aimirrorvip?&apikey=${global.xzn}&url=${url}&filter=naruto`)
...
_◦ Image To_ : ${res.your_choice_filter}`
  await conn.sendFile(m.chat, res.generated_image_addresses, 'naruto.jpg', kemii, m)
}
