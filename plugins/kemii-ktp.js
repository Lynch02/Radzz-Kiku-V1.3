...
let handler = async (m, { conn, args, usedPrefix }) => {
    ...
    if (!args[0]) throw `.ktp 6288980870067|Elisabeth|Jakarta, 02-07-2023|Perempuan|Jepang|02/02|Suka makmur|Suka Maju|Islam|Belum Kawin|Mahasiswa|Indonesia|Seumur Hidup|Suka Mundur|Sukasuka`
