...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	if (!text) throw `Input Server!\n\nExample: ${usedPrefix + command} org.mc-complex.com`
	let dann = await fetch(`https://api.lolhuman.xyz/api/minecraft/${text}?apikey=${global.lolkey}`)
