...
let handler = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    let _p = usedPrefix
    const linkgc = 'https://chat.whatsapp.com/HHZHgmBviNMCOz03RSjaZb'
    const domain = 'https://panelv5.senjaxpedia.com'
    const apikey = 'ptla_YROcF0ArWUbqeaJvxAX7EDpwQlvPsRgF2tVryJyOa8i';
    const c_apikey = 'ptlc_9lM7T8TbwVWfBUM3VwcpLEjYo2PbiW3kWhqYWyIGZlp'
    switch (command) {
        case 'addusr': {
